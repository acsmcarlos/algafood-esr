...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, endereco_complemento) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, 1, '34400-900', 'Rua João Pinheiro', '1000', 'Centro', 'Apartamento 101');
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Pizza', '4 Queijos', 35, 1, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Refrigerante', 'Coca-Cola', 5, 1, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Suco', 'Laranja', 6, 1, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Salgado', 'Pastel de Queijo', 8.5, 1, 1);
